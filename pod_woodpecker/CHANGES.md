...
## 3.16.0-1-1 (2026-06-27)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.15.1-1 to 3.16.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.15.1-1 to 3.16.0-1

## 3.15.0-1-1 (2026-05-28)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.14.1-2 to 3.15.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.14.1-1 to 3.15.0-1

## 3.14.1-2-3 (2026-05-26)

### Enhancements

- Improve monit connectivity check

## 3.14.1-2-2 (2026-05-26)

### Enhancements

- Improve monit connectivity check

## 3.14.1-2-1 (2026-05-16)

### Bugs

- Update pod_woodpecker_woodpecker_agent_version from 3.14.1-1 to 3.14.1-2

## 3.14.1-1-1 (2026-05-12)

### Bugs

- Update pod_woodpecker_woodpecker_agent_version from 3.14.0-1 to 3.14.1-1
- Update pod_woodpecker_woodpecker_server_version from 3.14.0-1 to 3.14.1-1

## 3.14.0-1-1 (2026-05-11)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.13.0-2 to 3.14.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.13.0-1 to 3.14.0-1

## 3.13.0-2-1 (2026-01-25)

### Bugs

- Update pod_woodpecker_woodpecker_agent_version from 3.13.0-1 to 3.13.0-2

## 3.13.0-1-1 (2026-01-14)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.12.0-2 to 3.13.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.11.0-1 to 3.13.0-1

## 3.12.0-2-1 (2026-01-10)

### Enhancements

- Update pod_woodpecker_woodpecker_agent_version from 3.12.0-1 to 3.12.0-2

## 3.12.0-1-1 (2025-11-28)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.11.0-1 to 3.12.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.11.0-1 to 3.12.0-1

## 3.11.0-1-1 (2025-11-10)

### Changes

- Rename parameter from `pod_woodpecker_monitor_monit_state` to `pod_woodpecker_monit_state`
...
- Update pod_woodpecker_woodpecker_agent_version from 3.9.0-1 to 3.10.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.9.0-1 to 3.10.0-1

## 3.9.0-1 (2025-08-24)

### Features

- Update pod_woodpecker_woodpecker_agent_version from 3.8.0-1 to 3.9.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.8.0-1 to 3.9.0-1
...
- Update pod_woodpecker_woodpecker_agent_version from 3.7.0-1 to 3.8.0-1
- Update pod_woodpecker_woodpecker_server_version from 3.7.0-1 to 3.8.0-1
